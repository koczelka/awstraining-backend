...
public class TranslatorConfig {
    ...
    AmazonTranslate configureTranslatorClient() {
        ...
        if (snsAccessKey != null && snsSecretKey !=null )
            return AmazonTranslateClientBuilder.standard().withCredentials(new AWSStaticCredentialsProvider(new BasicAWSCredentials(snsAccessKey, snsSecretKey))).withRegion(awsRegion).build();
